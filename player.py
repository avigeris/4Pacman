...
class Player:
    def __init__(self, app, pos, algo):
        self.app = app
        self.grid_pos = pos
        ...
        if self.algo == 'DFS':
            ...
            self.path = SearchProblem.depthFirstSearch(getGraph(), (self.app.p_pos[0], self.app.p_pos[1]),
                                                        (self.app.coins[0][0], self.app.coins[0][1]))
            print("Time spent for search: %s seconds" % (time.time() - start_time))
            print("Steps to goal: ", len(self.path))
            print("Memory spent: ", sys.getsizeof(
                SearchProblem.depthFirstSearch(getGraph(), (self.app.p_pos[0], self.app.p_pos[1]),
                                               (self.app.coins[0][0], self.app.coins[0][1]))), " bytes")
        elif self.algo == 'BFS':
            print("We use BFS")
            print("BFS: ")
            start_time = time.time()
            self.path = SearchProblem.breadthFirstSearch(getGraph(), (self.app.p_pos[0], self.app.p_pos[1]),
                                                          (self.app.coins[0][0], self.app.coins[0][1]))
            print("Time spent for search: %s seconds" % (time.time() - start_time))
            print("Steps to goal: ", len(self.path))
            print("Memory spent: ", sys.getsizeof(
                SearchProblem.breadthFirstSearch(getGraph(), (self.app.p_pos[0], self.app.p_pos[1]),
                                                 (self.app.coins[0][0], self.app.coins[0][1]))), " bytes")
        elif self.algo == 'A':
            print("We use A-Star")
            print("A-Star: ")
            start_time = time.time()
            self.path = SearchProblem.astar(getFree(), (self.app.p_pos[0], self.app.p_pos[1]),
                                             (self.app.coins[0][0], self.app.coins[0][1]))
            print("Time spent for search: %s seconds" % (time.time() - start_time))
            print("Steps to goal: ", len(self.path))
            print("Memory spent: ", sys.getsizeof(SearchProblem.astar(getFree(), (self.app.p_pos[0], self.app.p_pos[1]),
                                                                      (self.app.coins[0][0], self.app.coins[0][1]))),
                  " bytes")
        elif self.algo == 'greedy':
            print("Greedy: ")
            start_time = time.time()
            self.path = SearchProblem.greedy(getFree(), (self.app.p_pos[0], self.app.p_pos[1]),
                                              (self.app.coins[0][0], self.app.coins[0][1]))
            print("Time spent for search: %s seconds" % (time.time() - start_time))
            print("Steps to goal: ", len(self.path))
            print("Memory spent: ", sys.getsizeof(
                SearchProblem.greedy(getFree(), (self.app.p_pos[0], self.app.p_pos[1]),
                                     (self.app.coins[0][0], self.app.coins[0][1]))), " bytes")
