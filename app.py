...
class App:
    def __init__(self):
        ...
        self.load()
        self.algo = 'BFS'
        self.player = Player(self, self.p_pos, self.algo)
...
######################### intro functions ######################
    ...
    def start_draw(self):
        ...
        self.draw_text('PUSH SPACE BAR FOR BFS', self.screen, [WIDTH//2, HEIGHT//2], START_TEXT_SIZE, (170, 132, 58), START_FONT)
...
########################### game over functions ################################
    ...
    def game_over_draw(self):
        ...
        again_text = "Press SPACE to PLAY AGAIN with the same algo"
        algo_text = "d for DFS or b for BFS or a for A* or g for Greedy"
        ...
        self.draw_text(algo_text, self.screen, [
            WIDTH // 2, HEIGHT // 4], 20, (190, 190, 190), START_FONT)
        pygame.display.update()
